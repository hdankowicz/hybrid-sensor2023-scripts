...
prob = coco_add_slot(prob, 'rec', @corr_begin,  data, 'corr_begin' );
prob = coco_add_slot(prob, 'rec', @corr_step,   data, 'corr_step'  );
prob = coco_add_slot(prob, 'rec', @corr_end,    data, 'corr_end'   );

prob = coco_add_slot(prob, 'rec', @save_red, data, 'save_reduced');

prob = coco_add_slot(prob, 'rec', @bd_add, data, 'bddat');
end
